...
class EditacaraView extends GetView<EditacaraController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('PERBARUI DATA ACARA'),
        centerTitle: true,
        backgroundColor: Colors.black,
      ),
      body: FutureBuilder<Map<String, dynamic>?>(
          future: controller.getAcara(Get.arguments.toString()),
              ...
              return SingleChildScrollView(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      GetBuilder<EditacaraController>(builder: (imc) {
                        return InkWell(
                            onTap: () {
                              imc.pickImage();
                            },
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Smalltext(
                              text: "Perbaru alaman acara terbaru ",
                              color: Color.fromARGB(255, 165, 165, 164),
                            )
                          ],
                        ),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Smalltext(
                              text: "Perbarui waktu atau jam acara terbaru ",
                              color: Color.fromARGB(255, 165, 165, 164),
                            )
                          ],
                        ),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Smalltext(
                              text:
                                  "Perbarui keterang dan penjelasan acara terbaru",
                              color: Color.fromARGB(255, 165, 165, 164),
                            )
                          ],
                        ),
